...
- `kmd-daemon` (background service)
- `kmd-desktop` (desktop launcher)

## 1) Single Product Version

- Keep the four Cargo package versions identical.
...
- Default policy: all four package versions move together.
